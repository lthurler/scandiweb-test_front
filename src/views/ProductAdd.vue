    ...
    setup() {
        ...
        const rules = computed(() => {
            ...
            return {
              ...
              weight: state.product_type === 'book' && { required: helpers.withMessage('Please, submit required price', required),
              ...
              size: state.product_type === 'size' && { required: helpers.withMessage('Please, submit required price', required),
                maxLength: helpers.withMessage('Maximum size is 4', maxLength(4)),
                integer: helpers.withMessage('Please, provide integer only', integer)
              },
              height: state.product_type === 'furniture' && { required: helpers.withMessage('Please, submit required price', required),
                maxLength: helpers.withMessage('Maximum height is 4', maxLength(4)),
                integer: helpers.withMessage('Please, provide integer only', integer)
              },
              width: state.product_type === 'furniture' && { required: helpers.withMessage('Please, submit required price', required),
                maxLength: helpers.withMessage('Maximum width is 4', maxLength(4)),
                integer: helpers.withMessage('Please, provide integer only', integer)
              },
              length: state.product_type === 'furniture' && { required: helpers.withMessage('Please, submit required price', required),
